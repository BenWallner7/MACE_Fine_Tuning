...
initial_structure_path = '/data/fast-pc-02/CRSid/fine_tuning_assignment/md_run_on_fine_tuned/structures_for_md_runs/layer_1_hydroxide_water_graphene_system.xyz'

init_conf = read(initial_structure_path, '0')
init_conf.set_calculator(MACECalculator(model_path, device='cuda', default_dtype='float32', enable_cueq=True))
